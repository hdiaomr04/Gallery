  ...
  <div class="container py-5">
    <div class="row h-100 align-items-center py-5">
      <div class="col-lg-6">
        ...
        <p class="lead text-muted mb-0">welcome to galllery</p>
        <p class="lead text-muted">picture store <a href="https://bootstrapious.com/snippets" class="text-muted"> 
                    <u></u></a>
        </p>
      </div>
  ...
  <div class="container py-5">
    <div class="row align-items-center mb-5">
      <div class="col-lg-6 order-2 order-lg-1"><i class="fa fa-bar-chart fa-2x mb-3 text-primary"></i>
        <h2 class="font-weight-light">the gallery of designer</h2>
        <p class="font-italic text-muted mb-4">we create, serve and implement our work to our custumer</p><a href="#" class="btn btn-light px-5 rounded-pill shadow-sm">Learn More</a>
      </div>
